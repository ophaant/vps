#!/bin/bash
#shadowsocks-libev obfs install by DEVELOPER
...
cd /usr/bin
wget -O add-ss "https://raw.githubusercontent.com/ophaant/vps/main/gaspoll/add-ss.sh"
wget -O del-ss "https://raw.githubusercontent.com/ophaant/vps/main/gaspoll/del-ss.sh"
wget -O cek-ss "https://raw.githubusercontent.com/ophaant/vps/main/gaspoll/cek-ss.sh"
wget -O renew-ss "https://raw.githubusercontent.com/ophaant/vps/main/gaspoll/renew-ss.sh"
chmod +x add-ss
chmod +x del-ss
chmod +x cek-ss
chmod +x renew-ss
